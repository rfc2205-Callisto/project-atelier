...
class QuestionList extends React.Component {
  ...
  helpfulButton=(e)=>{
    ...
    if(helpful){
      axios.put(`qa/questions/${id}/helpful`).then(()=>{console.log('yayyy')}).catch((err)=>{console.log('question helpfulness not submitted')});
    }
  }
              ...
              return (
                <div class="oneQ">
                  <div class="partQ" id={Quest.question_id}>
                    ...
                    <div class="helpfulness" onClick={this.helpfulButton}>Helpful? Yes({Quest.question_helpfulness})</div>
                    <div class="addAns" >
